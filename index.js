...
app.post('/upload-csv', async(req, res) => {
    const filePath = "C:/Users/DELL/Desktop/TECNOLOGIAS DE LA INFORMACION/6 Sexto Semestre/Programacion web/CSVAPostgreSQL-main/uploads/countries.csv"; // Ruta del archivo CSV
    const results = [];
